      ...
      <head>
        ...
        <style>
          * {
          ...
          /* Subtle gradient from bottom center */
          .bottom-gradient {
            position: absolute;
            bottom: 0;
            left: 0;
            right: 0;
            height: 70%;
            background: radial-gradient(ellipse 120% 70% at 50% 100%, rgba(255, 213, 0, 0.035) 0%, rgba(255, 213, 0, 0.015) 40%, transparent 80%);
            pointer-events: none;
          }
      ...
      <body>
        ...
        <div class="content">
          ...
          <div class="cta-badge">
            ...
            <svg class="cta-cursor" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.5 3.21V20.8C5.5 21.22 5.97 21.48 6.32 21.25L10.79 18.3L12.79 22.82C12.94 23.17 13.35 23.33 13.7 23.18L15.61 22.37C15.96 22.22 16.12 21.81 15.97 21.46L13.97 16.94L19.26 16.04C19.68 15.97 19.88 15.48 19.61 15.15L6.11 2.68C5.79 2.31 5.21 2.5 5.21 3V3.21H5.5Z" fill="#FAFAFA"/>
            </svg>
          </div>
          
          
          <div class="url">crafterstation.com</div>
        </div>
